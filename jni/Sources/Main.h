...
#error "Invalid libeng version: Expected 1.2.8 version"
    ...
    !defined(LIBENG_ENABLE_CAMERA) // || !defined(LIBENG_ENABLE_INTERNET) || !defined(LIBENG_ENABLE_ADVERTISING)
#error "Wrong libeng configuration"
#endif

#if defined(LIBENG_ENABLE_GAMEPAD) || \
    defined(LIBENG_ENABLE_DELTA) || \
    defined(LIBENG_ENABLE_PROGRESS) || \
    defined(LIBENG_ENABLE_SPRITE) || \
    defined(LIBENG_USE_RTTI) || \
    defined(LIBENG_ENABLE_SCROLLING) || \
    defined(LIBENG_ENABLE_MIC) || \
    defined(LIBENG_CAM_FREEZER) || \
    defined(LIBENG_ENABLE_SOCIAL) || defined(LIBENG_ENABLE_INTERNET) || defined(LIBENG_ENABLE_ADVERTISING)
...
#define PROJECT_NAME            "PuzzleCAM"
#ifdef __ANDROID__
#define JAVA_PROJECT_NAME       "com/studio/artaban/puzzlecam"
...
inline void init(PlatformData& data) {
    ...
    data.game = static_cast<Game*>(PuzzleCAM::getInstance());
}
